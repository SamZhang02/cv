...
\resumeItemListStart
\resumeItem{Contributed to Meituan's advertisement recommendation system, the largest local life service platform in China.}
\resumeItem{Researching and developing the click-through rate (CTR) model for the Dianping app's homepage ad.}
\resumeItem{Conducting offline experiments to evaluate model performance and iteratively improved the models.}
\resumeItem{Performing big data analysis and feature engineering using the \textbf{Hadoop ecosystem (Hive, Spark, \ldots)}}
\resumeItem{Modeling, training, and fine-tuning the models using \textbf{TensorFlow}.}
\resumeItemListEnd
